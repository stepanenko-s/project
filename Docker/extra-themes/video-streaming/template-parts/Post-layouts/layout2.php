...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="layout2">
    <?php $video_streaming_postimg_lay = get_theme_mod( 'video_streaming_post_featured_image','Image');
    if($video_streaming_postimg_lay == 'Image'){ ?>
      <div class="box-image mb-3">
        <?php the_post_thumbnail(); ?>
      </div>
    <?php }
    if($video_streaming_postimg_lay == 'Color'){ ?>
